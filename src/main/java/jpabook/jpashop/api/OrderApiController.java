...
public class OrderApiController {
    ...
    public List<OrderDto> getOrdersV3WithPage(@RequestParam(value = "offset", defaultValue = "0") int offset,
                                              @RequestParam(value = "limit", defaultValue = "100") int limit) {
        List<Order> findOrders = orderRepository.findAllWithMemberAndDelivery(offset, limit);
        List<OrderDto> result = findOrders.stream()
                .map(o -> new OrderDto(o))
                .collect(Collectors.toList());
        return result;
    ...
    public List<OrderQueryDto> getOrdersv6() {
        List<OrderFlatDto> orderFlatDtos = orderQueryRepository.findAllByDtosFlat();
